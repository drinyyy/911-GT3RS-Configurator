...
var require_is_plain_object = __commonJS({
  "node_modules/is-plain-object/index.js"(exports, module) {
    ...
    module.exports = function isPlainObject(o15) {
      var ctor, prot;
      if (isObjectObject(o15) === false) return false;
    ...
    const p5 = (e15) => {
      for (c6 in e15) {
        ...
        for (g5 of z2) {
          ...
          } else void 0 === o15 && (o15 = [[], t14, r15]), c6 = R3 || 36 !== c6.charCodeAt(0) ? c6 : `--${S(n7.prefix)}${c6.slice(1).replace(/\$/g, "-")}`, g5 = z3 ? g5 : "number" == typeof g5 ? g5 && e16 in I ? String(g5) + "px" : String(g5) : k(m(e16, null == g5 ? "" : g5), n7.prefix, n7.themeMap[e16]), o15[0].push(`${R3 ? `${c6} ` : `${d(c6)}:`}${g5}`);
        }
      }
      var b5, $4;
    };
...
var P = (e13, t13, r14) => {
  const [n7, i6, o15, a5] = L(t13.composers), c6 = "function" == typeof t13.type || t13.type.$$typeof ? ((e14) => {
    ...
    for (const e14 in o15) if (delete p6[e14], e14 in l7) {
      let t14 = l7[e14];
    ...
    for (const [n8, i7, o16, l8] of t13.composers) {
      ...
      for (const i8 of t14) if (void 0 !== i8) for (const [t15, o17, l9] of i8) {
      ...
      for (const t15 of s7) if (void 0 !== t15) for (const [i8, o17] of t15) {
...
function getPlacementData({ anchorRect: p5, popperSize: c6, arrowSize: f5, arrowOffset: l7 = 0, side: d5, sideOffset: h5 = 0, align: x4, alignOffset: g5 = 0, shouldAvoidCollisions: u5 = true, collisionBoundariesRect: w4, collisionTolerance: m5 = 0 }) {
  ...
  const R3 = s2(S4, $4), M3 = y5[a2(d5)][x4], D2 = function(t13, e13, r14) {
    ...
    if (("start" === o15 || "center" === o15) && (n7[p6] && c7 || n7[a5] && !c7)) return "end";
    if (("end" === o15 || "center" === o15) && (n7[a5] && c7 || n7[p6] && !c7)) return "start";
    return o15;
  ...
  const { present: o15, children: i6 } = u5, s6 = function(n7) {
    ...
    return t8.useEffect(() => {
      ...
      if (t13 !== n7) {
        ...
        if (n7) m5("MOUNT");
        else if ("none" === o17 || "none" === (null == e13 ? void 0 : e13.display)) m5("UNMOUNT");
        else {
          const e14 = u7 !== o17;
...
function getVectorSchema(dimension) {
  ...
  const isVectorObject = (o15) => {
    if (!o15 || typeof o15 !== "object") return false;
...
var y3 = { string: [[function(r14) {
  ...
  if (!t11(n7) || !t11(a5) || !t11(o15)) return null;
  var h5 = function(r15) {
...
function c5(e13, r14) {
  ...
  for (n7 = 0; n7 < a5.length; n7++) r14.indexOf(t13 = a5[n7]) >= 0 || (o15[t13] = e13[t13]);
  return o15;
}
function i5(e13) {
...
function _unsupportedIterableToArray(o15, minLen) {
  if (!o15) return;
  if (typeof o15 === "string") return _arrayLikeToArray(o15, minLen);
  var n7 = Object.prototype.toString.call(o15).slice(8, -1);
  if (n7 === "Object" && o15.constructor) n7 = o15.constructor.name;
  if (n7 === "Map" || n7 === "Set") return Array.from(o15);
  if (n7 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n7)) return _arrayLikeToArray(o15, minLen);
}
...
function _unsupportedIterableToArray2(o15, minLen) {
  if (!o15) return;
  if (typeof o15 === "string") return _arrayLikeToArray2(o15, minLen);
  var n7 = Object.prototype.toString.call(o15).slice(8, -1);
  if (n7 === "Object" && o15.constructor) n7 = o15.constructor.name;
  if (n7 === "Map" || n7 === "Set") return Array.from(o15);
  if (n7 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n7)) return _arrayLikeToArray2(o15, minLen);
}
